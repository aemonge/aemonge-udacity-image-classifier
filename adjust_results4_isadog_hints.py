...
#       comments below that start with "DONE: 4" for the adjust_results4_isadog
...
def adjust_results4_isadog(results_dic, dogfile):
    ...
    with open(dogfile, "r") as infile:
        ...
        while line != "":
            ...
            # DONE: 4a. REPLACE pass with CODE to remove the newline character
            #           from the variable line
            #
            # Process line by striping newline from line
            pass

            # DONE: 4b. REPLACE pass with CODE to check if the dogname(line)
